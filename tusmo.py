...
def check_match(input, word, G_l):
    matchs = ""
    color = ""
...
while True:
    ...
    if language == "en":
        ...
        if accent == "y":
            ...
            word_list = fr_word_list
            for mot in range(len(word_list)):
                word_list[mot] = word_list[mot].replace("é","e").replace("ô","o").replace("ç","c").replace("ê","e").replace("è","e").replace("à","a").replace("ù","u")
    ...
    while user_input != word:
        ...
        if language == "fr":
            ...
            print("word of {} letter".format(len(word)))
            print("letters found : {}".format(good_word))
        ...
        while len(user_input) != len(word):
            ...
            if user_input in word_list:
                if len(user_input) != len(word):
                    if user_input != "":
                        if language == "fr":
                            print("ce mot n'est pas de la bonne longueur ({})".format(len(user_input)-len(word)))
                        else:
                            print("this word isn't the right lenght ({})".format(len(user_input)-len(word)))

            else:
                if language == "fr":
                    print("ce mot n'est pas dans la liste de mots")
                else:
        ...
        if guess.replace(" ", "").replace("|", "") == word:
            ...
            for i in range(len(div)):
                print("|{} {}".format(str(div[i]), guessed_word[i]))
            print('\n')
